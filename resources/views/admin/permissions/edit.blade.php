    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-2">
                <div class="mt-6 p-2">
                    <h2 class="text-2xl font-semibold">Permission Edit</h2>
                </div>
                ...
                <div class="mt-6 p-2">
                    ...
                    <div class="flex space-x-2 mt-4 p-2">
                        ...
                        <button class="openModal px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md">{{ $permissionRole->name }}</button>
                            ...
                            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                ...
                                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-70">
                                            ...
                                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                <div class="mt-2">
                                                    <p class="text-sm text-gray-500">
                                                        Are you sure you want to remove role this {{ $permissionRole->name }}?
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex">
                                        <form action="{{ route('admin.permissions.roles.remove', [$permission,$permissionRole] )}}" method="post">
                                            @csrf
                                            @method('DELETE')
