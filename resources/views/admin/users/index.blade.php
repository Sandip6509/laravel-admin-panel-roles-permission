                                    ...
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th scope="col" class="relative px-6 py-3">
                                                <span class="sr-only" style="position: relative;">Actions</span>
                                            </th>
                                        </tr>
                                    </thead>
                                            ...
                                            <td>
                                                <div class="flex justify-end">
                                                    <div class="flex space-x-2">
                                                        <a href="{{ route('admin.users.show',$user) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white rounded-md">Roles</a>
